...
public class MountController {
	...
	@ResponseBody
	public FileShare mountDirectory(HttpSession session, @RequestParam("server") String server,
		...
		FileShare fileShare = new FileShare(server + sourcePath.replace(File.pathSeparatorChar, '_'), server,
				sourcePath, permissionSet, ShareType.CIFS);
