...
//
// public VirtueUserService(IInfrastructureService infrastructure,
// IVirtueDataAccessObject virtueDatabase) {
...
// }
//
// public List<ApplicationDefinition> getApplicationsForVirtue(User user, String
// virtueId) {
// List<ApplicationDefinition> list =
// virtueDatabase.getApplicationsForVirtue(user, virtueId);
// return list;
// }
//
...
// VirtueInstance virtue = infrastructure.provisionTemplate(user, template,
// useAlreadyProvisioned);
