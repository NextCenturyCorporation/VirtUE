...
public class VirtualBoxVmManager extends BaseVmManager implements IVmManager {
	...
	public AbstractVirtualMachine startVirtualMachine(AbstractVirtualMachine vm) {
		...
		try {
			...
			throw new SaviorException(SaviorException.ErrorCode.VM_ERROR, "Error attempting to start VM.  VM=" + vm, e);
		}
	}
	...
	public AbstractVirtualMachine stopVirtualMachine(AbstractVirtualMachine vm) {
		...
		try {
			...
			throw new SaviorException(SaviorException.ErrorCode.VM_ERROR, "Error attempting to stop VM.  VM=" + vm, e);
		}
	}
	...
	public void deleteVirtualMachine(AbstractVirtualMachine vm) {
		...
		try {
			...
			throw new SaviorException(SaviorException.ErrorCode.VM_ERROR, "Error attempting to delete VM.  VM=" + vm, e);
		}
	}

	public boolean pauseVm(AbstractVirtualMachine vm) {
		...
		try {
			...
			throw new SaviorException(SaviorException.ErrorCode.VM_ERROR, "Error attempting to pause VM.  VM=" + vm, e);
		}
	}

	public boolean resumeVm(AbstractVirtualMachine vm) {
		String id = vm.getInfrastructureId();
		...
		try {
			...
			throw new SaviorException(SaviorException.ErrorCode.VM_ERROR, "Error attempting to resume VM.  VM=" + vm, e);
		}
	}
	...
	public VmState getVirtialMachineState(AbstractVirtualMachine vm) {
		...
		try {
			...
			throw new SaviorException(SaviorException.ErrorCode.UNKNOWN_ERROR,
					"Error attempting to get vm state.  VM=" + vm, e);
		}
