...
ansible-playbook -i image-creator/${initFile} -e 'virtue_s3_bucket="${bucket}" encrypt_key="${encryptionKey}" virtue_s3_folder="${s3Folder}" kernelVersion=4.18.0-041800 host_key_checking=False virtue_apps="${apps}"' virtue-install-domU-apps.yml | tee image-creator/${initFile}.log
