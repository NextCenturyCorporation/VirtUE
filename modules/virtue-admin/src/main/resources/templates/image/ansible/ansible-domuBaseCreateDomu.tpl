...
ansible-playbook -i image-creator/${initFile} -e "virtue_s3_bucket=${bucket} host_key_checking=False" virtue-ubuntu-create-domU.yml | tee image-creator/${initFile}.log
