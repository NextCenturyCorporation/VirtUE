...
public class DndCanImportRequestMessage extends BaseClipboardMessage {
	...
	public DndCanImportRequestMessage(String clientId, String requestId, TransferSupport support) {
	...
	public String toString() {
		return "DndCanImportRequestMessage [requestId=" + requestId + ", flavors=" + flavors.length
