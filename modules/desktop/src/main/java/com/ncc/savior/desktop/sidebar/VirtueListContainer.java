...
public class VirtueListContainer extends AbstractVirtueContainer implements Comparable<VirtueListContainer> {
	...
	public VirtueListContainer(DesktopVirtue virtue, VirtueService virtueService, Color headerColor, JScrollPane sp,
	...
	public void updateVirtue(DesktopVirtue virtue) {
		this.virtue = virtue;
		String newLabel = virtue.getVirtueState().toString();
		SwingUtilities.invokeLater(() -> this.statusLabel.setText(newLabel));
